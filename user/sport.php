...
<?php 
    ...
    $model = new Products();
    $new = $model->getProductByCategory('sport')->fetchAll();
?>
<img src="img/sport.jpg" alt="" height="400px" class="w-100" />
<h1 style="text-align: center;position: absolute;top: 200px;left: 320px;color: white;text-transform: uppercase;">Découvrez notre gamme des produits Sportif</h1>
