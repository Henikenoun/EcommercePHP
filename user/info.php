...
<?php 
    ...
    $model = new Products();
    $new = $model->getProductByCategory('informatique')->fetchAll();
?>
<img src="img/info.jpg" alt="" height="400px" class="w-100" />
<h1 style="text-align: center;position: absolute;top: 200px;left: 220px;color: white;text-transform: uppercase;">DÉCOUVREZ NOTRE GAMME Des produits informatique</h1>
