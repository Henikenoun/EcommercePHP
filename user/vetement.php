...
<?php 
    ...
    $model = new Products();
    $new = $model->getProductByCategory('vetement')->fetchAll();
?>
<img src="img/vetement.jpg" alt="" height="400px" class="w-100" />
<h1 style="text-align: center;position: absolute;top: 200px;left: 320px;color: white;text-transform: uppercase;">DÉCOUVREZ NOTRE GAMME DE VÊTEMENTS</h1>
